...
public class ProductDetailsPage extends BasePage {
    ...
    @FindBy(xpath = ProductDetailsPageObject.BUTTON_ADD_TO_CART_XPATH)
    WebElement buttonAddToCartElement;

    // WebElement representing the 'Cart' link
    @FindBy(xpath = ProductDetailsPageObject.LINK_CART_XPATH)
    WebElement linkCartElement;

    // WebElement representing the 'Check Out' link
    @FindBy(xpath = ProductDetailsPageObject.LINK_CHECK_OUT_XPATH)
